import{r as C,j as d}from"./index-DirEgLJ3.js";import{c as b}from"./clsx-B-dksMZM.js";import{g as k,a as w,u as x,s as S,b as R,m as M,h as $,f as u,k as m}from"./Box-BEO0Rqom.js";import{f as U}from"./dividerClasses-Bl9wkvy7.js";function A(t){return String(t).match(/[\d.\-+]*\s*(.*)/)[1]||""}function j(t){return parseFloat(t)}function V(t){return k("MuiSkeleton",t)}w("MuiSkeleton",["root","text","rectangular","rounded","circular","pulse","wave","withChildren","fitContent","heightAuto"]);const X=t=>{const{classes:e,variant:a,animation:s,hasChildren:n,width:i,height:o}=t;return R({root:["root",a,s,n&&"withChildren",n&&!i&&"fitContent",n&&!o&&"heightAuto"]},V,e)},r=m`
  0% {
    opacity: 1;
  }
